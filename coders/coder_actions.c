...
/*   Updated: 2026/09/07 10:48:26 by srandro          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "codexion.h"

static void	in_middle_of_compilation(t_coder *coder, long long *debug_timestamp)
{
	struct timespec	ts;
	long long		target;
...
long long	coder_is_compiling(t_coder *coder, long long debug_timestamp)
{
	...
	in_middle_of_compilation(coder, &debug_timestamp);
